...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox_pretty(
    ...
    LGUI(LSFT(KC_S)),KC_MAC_UNDO,    KC_MAC_COPY,    KC_MAC_PASTE,   KC_GRAVE,       KC_TILD,        KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_AMPR,        KC_1,           KC_2,           KC_3,           KC_BSLASH,      KC_TRANSPARENT,
    TO(0),          KC_EQUAL,       KC_PERC,        KC_CIRC,        KC_TILD,                                                                                                        KC_CIRC,        KC_DOT,         KC_0,           KC_EQUAL,       KC_TRANSPARENT,
